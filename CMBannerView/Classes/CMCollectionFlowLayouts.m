...
+ (instancetype)layoutWithStyle:(CMCollectionFlowLayoutsStyle)style{
    if (style == CMCollectionFlowLayoutsStyle_Liner) {
     ...
     CMCollectionFlowLayouts_Scale *layout =  [[CMCollectionFlowLayouts_Scale alloc] init];
        layout.cm_scale = 0.8;
        layout.cm_alpha = 0.8;
        return layout;
    }else if (style ==CMCollectionFlowLayoutsStyle_Angle) {
        CMCollectionFlowLayouts_Angle *layout =  [[CMCollectionFlowLayouts_Angle alloc] init];
        layout.cm_alpha = 0.8;
        return layout;
